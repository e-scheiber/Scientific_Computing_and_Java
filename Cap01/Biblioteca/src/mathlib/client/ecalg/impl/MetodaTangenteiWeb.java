 ...
 */
public class MetodaTangenteiWeb implements IMetodaTangentei{
  //Logger logger=Logger.getLogger(mathlib.client.ecalg.impl.MetodaTangenteiWeb.class.getName());

  public MetodaTangenteiWeb(){
    /*
    try{
      FileHandler loggingFile = new FileHandler("webapps/appecalg/resultsEcalg.log");
