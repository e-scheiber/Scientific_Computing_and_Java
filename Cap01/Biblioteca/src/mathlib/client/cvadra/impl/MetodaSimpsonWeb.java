...
public class MetodaSimpsonWeb implements IMetodaSimpson{
  ...
  //Logger logger=Logger.getLogger(mathlib.client.cvadra.impl.MetodaSimpsonWeb.class.getName());
  
  public MetodaSimpsonWeb(){
    /*
    try{
      FileHandler loggingFile = new FileHandler("webapps/appinteg/resultsInteg.log");
